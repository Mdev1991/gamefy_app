      ...
      : id = json["id"],
        ...
        modes = json["game_modes"] == null
            ...
            : (json["game_modes"] as List)
                .map((i) => new ModeModel.fromJson(i))
                .toList(),
        ...
        keywords = json["keywords"] == null
            ...
            : (json["keywords"] as List)
                .map((i) => new KeywordModel.fromJson(i))
                .toList(),
        platforms = json["platforms"] == null
            ? null
            : (json["platforms"] as List)
                .map((i) => new PlatformModel.fromJson(i))
                .toList(),
        perspectives = json["player_perspectives"] == null
            ? null
            : (json["player_perspectives"] as List)
                .map((i) => new PlayerPerspectiveModel.fromJson(i))
                .toList(),
        ...
        videos = json["videos"] == null
            ? null
            : (json["videos"] as List)
                .map((i) => new VideoModel.fromJson(i))
                .toList(),
